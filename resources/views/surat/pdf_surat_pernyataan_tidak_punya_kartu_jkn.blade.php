...
<head>
    <meta charset="UTF-8">
    <title>Surat Pernyataan Tidak Memiliki Kartu JAMKESMAS, ASKES atau JKN</title>
...
<body>
    ...
    <table class="data">
        ...
        <tr>
            ...
            <td class="value">
                {{ $data->tempat_lahir ?? '-' }},
                {{ !empty($data->tanggal_lahir) ? \Carbon\Carbon::parse($data->tanggal_lahir)->format('d-m-Y') : '-' }}
            </td>
        </tr>
    ...
    <!-- ISI SURAT -->
    <p class="paragraf">
        Menyatakan bahwa saya tidak mempunyai kartu JAMKESMAS, ASKES atau JKN
    </p>

    <p class="paragraf">
        Demikian surat pernyataan ini dibuat dan dipergunakan dengan ketentuan yang
