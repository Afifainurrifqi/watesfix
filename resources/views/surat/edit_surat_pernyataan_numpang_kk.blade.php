    ...
    <div class="container">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form
                    action="{{ isset($suratPernyataanNumpangKk) ? route('surat.numpangkk.update', $suratPernyataanNumpangKk->_id) : route('surat.numpangkk.store') }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tempat_lahir_penumpang_kk" id="tempat_lahir_penumpang_kk"
                            ...
                            value="{{ old('tempat_lahir_penumpang_kk', $suratPernyataanNumpangKk->tempat_lahir_penumpang_kk ?? '') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_lahir_penumpang_kk" id="tanggal_lahir_penumpang_kk"
                            class="form-control" required
                            value="{{ old('tanggal_lahir_penumpang_kk', $formatTanggalInput($suratPernyataanNumpangKk->tanggal_lahir_penumpang_kk ?? '')) }}">
                    </div>
