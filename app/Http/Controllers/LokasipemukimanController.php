...
class LokasipemukimanController extends Controller
{
    ...
    public function jsonadmin(Request $request)
    {
        ...
        $query = Datapenduduk::query()
            ->whereIn('datapenduduks.Datak', $allowedDatakValues)
            ->where('datapenduduks.hubungan', 'Kepala Keluarga') // ✅ ini kuncinya
            ->join('detailkks', 'detailkks.idpenduduk', '=', 'datapenduduks.id') // sesuaikan kalau beda
            ->join('kks', 'kks.id', '=', 'detailkks.idkk')                     // sesuaikan kalau beda
        ...
        return DataTables::of($query)
            ...
            ->addColumn('nowa', function ($row) {
                $dataIndividu = dataindividu::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('nik_kepala', function ($row) {
                $lokasi = lokasipemukiman::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_paud', function ($row) {
                $akses_pendidikan = akses_pendidikan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_rumahs', function ($row) {
                $datakesehatan = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_rumahb', function ($row) {
                $dataRumahB = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_poliklinik', function ($row) {
                $dataPoliklinik = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_puskesmas', function ($row) {
                $dataPuskesmas = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_poskedes', function ($row) {
                $dataPoskedes = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_posyandu', function ($row) {
                $dataPosyandu = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_apotik', function ($row) {
                $dataApotik = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_toko_obat', function ($row) {
                $dataTokoObat = akseskesehatan::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jaraktempuh_dr_spesialis', function ($row) {
                $data = aksestenagakerja::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('jenistrasport_lokasipu', function ($row) {
                $akses_sarpras = aksessarpras::where('nik_kepala', $row->nik)->first();
            ...
            ->addColumn('pengtransportsebelum', function ($row) {
                $datakesehatan = laink::where('nik_kepala', $row->nik)->first();
