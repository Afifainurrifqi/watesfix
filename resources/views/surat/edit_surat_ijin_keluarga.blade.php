                    ...
                    <form action="{{ route('surat.ijin_keluarga.update', $surat) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nama_suami" class="form-control" value="{{ old('nama_suami', $surat->nama_suami) }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Tempat Lahir Suami</label>
                                <input type="text" name="tempat_lahir_suami" class="form-control" value="{{ old('tempat_lahir_suami', $surat->tempat_lahir_suami) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="tanggal_lahir_suami" class="form-control" value="{{ old('tanggal_lahir_suami', $surat->tanggal_lahir_suami) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="pekerjaan_suami" class="form-control">
                                    ...
                                    @foreach (['BELUM/TIDAK BEKERJA','PELAJAR/MAHASISWA','TIDAK/BELUM SEKOLAH','KARYAWAN SWASTA','IBU RUMAH TANGGA','WIRASWASTA','TNI','POLRI','DOSEN','GURU','KEPALA DESA','PERANGKAT DESA','BIDAN','DOKTER','PERAWAT','PETANI/PEKEBUN PEMILIK LAHAN','BURUH TANI/PERKEBUNAN','PEDAGANG','PNS','BURUH HARIAN LEPAS','SOPIR','KARYAWAN BUMN','PENSIUNAN','PEMBANTU RUMAH TANGGA','BURUH PETERNAKAN','KONSTRUKSI','PELAUT','NELAYAN/PERIKANAN','KARYAWAN HONORER','PETERNAK','MEKANIK','PENATA RIAS','TUKANG LAS/PANDAI BESI','INDUSTRI','USTADZ/MUBALIGH','TABIB','BURUH NELAYAN/PERIKANAN','JURU MASAK','SENIMAN','AKUNTAN','Petani/Pekebun penyewa','TKI','Lainnya'] as $p)
                                        <option value="{{ $p }}" {{ old('pekerjaan_suami', $surat->pekerjaan_suami) == $p ? 'selected' : '' }}>{{ $p }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nama_istri" class="form-control" value="{{ old('nama_istri', $surat->nama_istri) }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Tempat Lahir Istri</label>
                                <input type="text" name="tempat_lahir_istri" class="form-control" value="{{ old('tempat_lahir_istri', $surat->tempat_lahir_istri) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="tanggal_lahir_istri" class="form-control" value="{{ old('tanggal_lahir_istri', $surat->tanggal_lahir_istri) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="pekerjaan_istri" class="form-control">
                                    <option value="">-- Pilih Pekerjaan --</option>
                                    @foreach (['BELUM/TIDAK BEKERJA','PELAJAR/MAHASISWA','TIDAK/BELUM SEKOLAH','KARYAWAN SWASTA','IBU RUMAH TANGGA','WIRASWASTA','TNI','POLRI','DOSEN','GURU','KEPALA DESA','PERANGKAT DESA','BIDAN','DOKTER','PERAWAT','PETANI/PEKEBUN PEMILIK LAHAN','BURUH TANI/PERKEBUNAN','PEDAGANG','PNS','BURUH HARIAN LEPAS','SOPIR','KARYAWAN BUMN','PENSIUNAN','PEMBANTU RUMAH TANGGA','BURUH PETERNAKAN','KONSTRUKSI','PELAUT','NELAYAN/PERIKANAN','KARYAWAN HONORER','PETERNAK','MEKANIK','PENATA RIAS','TUKANG LAS/PANDAI BESI','INDUSTRI','USTADZ/MUBALIGH','TABIB','BURUH NELAYAN/PERIKANAN','JURU MASAK','SENIMAN','AKUNTAN','Petani/Pekebun penyewa','TKI','Lainnya'] as $p)
                                        <option value="{{ $p }}" {{ old('pekerjaan_istri', $surat->pekerjaan_istri) == $p ? 'selected' : '' }}>{{ $p }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="negara_tujuan" class="form-control" value="{{ old('negara_tujuan', $surat->negara_tujuan) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Sebagai</label>
                                <input type="text" name="sebagai" class="form-control" value="{{ old('sebagai', $surat->sebagai) }}">
                            </div>
                        </div>
