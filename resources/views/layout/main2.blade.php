...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../../assets/images/Wates.png">
    <!-- Pignose Calender -->
            ...
            <div class="header-content clearfix">
                ...
                <div class="header-left">
                    <div class="input-group icons">
                        <span class="brand-title">
                            <img src="/assets/images/Wates.png" style="width:20%" alt="">
                        </span>
                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                ...
                                <img src="/assets/images/Wates.png" height="40" width="40" alt="">
                            </div>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="nav-link {{ request()->segment('1') == 'home' ? 'active' : '' }}"
                            href="{{ route('datapenduduk.index_admin') }}" aria-expanded="false">
                            <i class="fas fa-users menu-icon"></i><span class="nav-text">Data Penduduk</span>
                        </a>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="nav-link {{ request()->segment('1') == 'home' ? 'active' : '' }}"
                            href="{{ '/datamutasi/admin' }}" aria-expanded="false">
                            <i class="fas fa-random menu-icon"></i><span class="nav-text">Data Mutasi</span>
                        </a>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="nav-link {{ request()->segment('1') == 'home' ? 'active' : '' }}"
                            href="{{ route('dasawisma.index_admin') }}" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('rt_kegiatanwarga.admin_index') }}">KEGIATAN WARGA UNTUK MENJAGA KEAMANAN
                                    LINGKUNGAN SELAMA SATU TAHUN TERAKHIR</a></li>
                        </ul>
                    </li>
