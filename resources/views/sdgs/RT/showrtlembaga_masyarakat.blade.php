                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="{{ route('rtlembaga_masyarakat.update') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        @if (isset($rtlembaga_masyarakat->jumlah_ang))
                                        <br>
                                        {{ $rtlembaga_masyarakat->jumlah_ang }}
                                    @else
                                        <!-- Tindakan atau pesan jika kondisi_pekerjaan kosong -->
                                        Data tidak tersedia.
                                    @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        @if (isset($rtlembaga_masyarakat->fasilitas))
                                        <br>
                                        {{ $rtlembaga_masyarakat->fasilitas }}
                                    @else
                                        <!-- Tindakan atau pesan jika kondisi_pekerjaan kosong -->
                                        Data tidak tersedia.
                                    @endif
