                         ...
                         <div class="form-validation">
                             ...
                             <form class="form-valide" action="{{ route('datapenduduk.update', ['nik' => $valNIK]) }}"
                                 ...
                                 <div class="form-group row">
                                     <label class="col-lg-4 col-form-label" for="valKK">KK <span
                                             class="text-danger">*</span></label>
                                     <div class="col-lg-6">
                                         <input type="text" class="form-control" id="valNokk" name="valNokk"
                                             value="{{ old('valNokk', $valKK) }}" required>
                                         @error('valKK')
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input type="text" value="{{ $valGelara }}"
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input type="text" value="{{ $valNama }}"
                                             class="form-control @error('valNama') is-invalid @enderror" id="valNama"
                                             name="valNama" placeholder="Gelar Awalmu...">
                                         @error('valNama')
                                             <div id="" class="invalid-feedback">
                                                 {{ $message }}
                                             </div>
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input type="text" value="{{ $valGelart }}"
                                             class="form-control @error('valGelart') is-invalid @enderror" id="valGelart"
                                             name="valGelart" placeholder="Nama Lengkapmu...">
                                         @error('valGelart')
                                             <div id="" class="invalid-feedback">
                                                 {{ $message }}
                                             </div>
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <select name="valJeniskelamin"
                                             ...
                                             <option value="1" {{ $valJeniskelamin == '1' ? 'selected' : '' }}>
                                                 Laki-Laki</option>
                                             <option value="0" {{ $valJeniskelamin == '0' ? 'selected' : '' }}>
                                                 Perempuann</option>
                                         </select>
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input type="text" value="{{ $valTempatlahir }}"
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input type="date" vc
                                             ...
                                             id="valTanggallahir" name="valTanggallahir" value="{{ $valTanggallahir }}"
                                         ...
                                         <select class="form-control @error('valAgama') is-invalid @enderror"
                                             ...
                                             @foreach ($agama as $item)
                                                 <option value="{{ $item->id }}"
                                                     {{ $valAgama == $item->id ? 'selected' : '' }}>{{ $item->nama }}
                                                 </option>
                                             @endforeach
                                         </select>
                                         @error('valAgama')
                                     ...
                                     <div class="col-lg-6">
                                         <select class="form-control @error('valPendidikan') is-invalid @enderror"
                                             ...
                                             @foreach ($pendidikan as $item)
                                                 <option value="{{ $item->id }}"
                                                     {{ $valPendidikan == $item->id ? 'selected' : '' }}>
                                                     {{ $item->nama }}</option>
                                             @endforeach
                                         </select>
                                         @error('valPendidikan')
                                     ...
                                     <div class="col-lg-6">
                                         <select class="form-control @error('valGoldar') is-invalid @enderror"
                                             ...
                                             @foreach ($goldar as $item)
                                                 <option value="{{ $item->id }}"
                                                     {{ $valGoldar == $item->id ? 'selected' : '' }}>{{ $item->nama }}
                                                 </option>
                                             @endforeach
                                         </select>
                                         @error('valGoldar')
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         ...
                                         @enderror
                                         <div class="form-group row" id="tanggalPerkawinanFormGroup"
                                             style="display: none;">
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input type="text" value="{{ $valHubungan }}"
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input type="text" value="{{ $valAyah }}" class="form-control"
                                             @error('valAyah') is-invalid @enderror id="valAyah" name="valAyah"
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <input value="{{ $valAlamat }}" type="text"
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-6">
                                         <select name="valDatak"
                                             ...
                                             required>
                                             <option value="Tetap" {{ old('valDatak') == 'Tetap' ? 'selected' : '' }}>
                                                 Tetap</option>
                                             ...
                                             <option value="Tidaktetap"
                                                 {{ old('valDatak') == 'Tidaktetap' ? 'selected' : '' }}>Tidak tetap
                                             </option>
                                         </select>
                                         @error('valDatak')
                                             <div id="" class="invalid-feedback">
