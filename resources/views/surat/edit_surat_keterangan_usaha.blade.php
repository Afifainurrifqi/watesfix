...
<div class="container">
    <div class="card shadow-sm">
        <div class="card-body">
            <h4 class="mb-4">Edit Surat Keterangan Usaha</h4>
            ...
            @php
                ...
                $suratId = $surat->_id ?? $surat->id;
            @endphp

            <form action="{{ route('surat.usaha.update', $suratId) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                        ...
                        required
                        value="{{ old('tanggal_lahir', $formatTanggalInput($surat->tanggal_lahir ?? '')) }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="kewarganegaraan"
                        ...
                        @foreach (['WNI', 'WNA'] as $kw)
                            <option value="{{ $kw }}"
                                {{ old('kewarganegaraan', $surat->kewarganegaraan ?? '') == $kw ? 'selected' : '' }}>
                                {{ $kw }}
                            </option>
                        @endforeach
                    </select>
...
<script>
    ...
    function autofillUsaha() {
        ...
        fetch(`/datapenduduk/lookup/${nik}`)
            ...
            .then(result => {
                console.log('HASIL LOOKUP USAHA:', result);
