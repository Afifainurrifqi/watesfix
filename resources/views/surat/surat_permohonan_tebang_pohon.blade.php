...
@section('content')
    <div class="container">
        <div class="card shadow-sm">
            <div class="card-body">
                <h4 class="mb-4">Form Surat Permohonan Tebang Pohon</h4>
                ...
                <form action="{{ route('surat.permohonan_tebang_pohon.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jabatan" class="form-control" required value="{{ old('jabatan') }}"
                            placeholder="Contoh: Ketua RT 01 / Warga">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alasan_tebang" class="form-control" rows="5" required
                            placeholder="Jelaskan alasan secara detail (misalnya: pohon besar rawan tumbang, jamuran, dll)">{{ old('alasan_tebang') }}</textarea>
                    </div>
    ...
    <script>
        ...
        document.getElementById('nik').addEventListener('change', autofillTebangPohon);
    </script>
@endsection
