        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="{{ route('suratpernyataantidakbisamelampirkanktpkematian.update', $surat->_id) }}"
                    ...
                    <div class="mb-3">
                        <label for="tanggal_lahir_pelapor" class="form-label">
                            Tanggal Lahir Pelapor <span class="text-danger">*</span>
                        </label>

                        <input type="date" name="tanggal_lahir_pelapor" id="tanggal_lahir_pelapor" class="form-control"
                            value="{{ old('tanggal_lahir_pelapor', tanggalInput($surat->tanggal_lahir_pelapor)) }}"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jenis_kelamin_pelapor" id="jenis_kelamin_pelapor" class="form-control" required>
                            <option value="Laki-laki"
                                {{ old('jenis_kelamin_pelapor', $surat->jenis_kelamin_pelapor) == 'Laki-laki' ? 'selected' : '' }}>
                                Laki-laki</option>
                            <option value="Perempuan"
                                {{ old('jenis_kelamin_pelapor', $surat->jenis_kelamin_pelapor) == 'Perempuan' ? 'selected' : '' }}>
                                Perempuan</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nik_jenazah" id="nik_jenazah" class="form-control"
                    ...
                    <div class="mb-3">
                        <label for="tanggal_lahir_jenazah" class="form-label">
                            Tanggal Lahir Jenazah
                        </label>

                        <input type="date" name="tanggal_lahir_jenazah" id="tanggal_lahir_jenazah"
                            class="form-control"
                            value="{{ old('tanggal_lahir_jenazah', tanggalInput($surat->tanggal_lahir_jenazah)) }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jenis_kelamin_jenazah" id="jenis_kelamin_jenazah" class="form-control">
                            <option value="Laki-laki"
                                {{ old('jenis_kelamin_jenazah', $surat->jenis_kelamin_jenazah) == 'Laki-laki' ? 'selected' : '' }}>
                                Laki-laki</option>
                            <option value="Perempuan"
                                {{ old('jenis_kelamin_jenazah', $surat->jenis_kelamin_jenazah) == 'Perempuan' ? 'selected' : '' }}>
                                Perempuan</option>
                        </select>
                    </div>
