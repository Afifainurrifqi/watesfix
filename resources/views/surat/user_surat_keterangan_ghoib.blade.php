                    ...
                    <form action="{{ route('surat.userghoib.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nik" id="nik" class="form-control" required
                                value="{{ old('nik') }}" onblur="autofillGhoibUser()">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" id="status" class="form-control" required>
                                    ...
                                    <option value="Belum Kawin" {{ old('status') == 'Belum Kawin' ? 'selected' : '' }}>
                                        Belum Kawin</option>
                                    <option value="Kawin" {{ old('status') == 'Kawin' ? 'selected' : '' }}>Kawin
                                    </option>
                                    <option value="Cerai Hidup" {{ old('status') == 'Cerai Hidup' ? 'selected' : '' }}>
                                        Cerai Hidup</option>
                                    <option value="Cerai Mati" {{ old('status') == 'Cerai Mati' ? 'selected' : '' }}>
                                        Cerai Mati</option>
                                </select>
                            </div>
                        </div>
    ...
    <script>
        ...
        function normalisasiPekerjaan(value) {
            ...
            const aliases = {
                ...
                TENTARANASIONALINDONESIA: 'TNI',

                TENTARANASIONALINDONESIATNI: 'TNI',

                POLRI: 'POLRI',

                KEPOLISIANRI: 'POLRI',

                KEPOLISIANREPUBLIKINDONESIA: 'POLRI',

                KEPOLISIANRIPOLRI: 'POLRI',

                PNS: 'PNS',

                PEGAWAINEGERISIPIL: 'PNS',

                PEGAWAINEGERISIPILPNS: 'PNS',
            ...
            fetch(`/datapenduduk/lookup/${encodeURIComponent(nik)}`, {
                ...
                .then(result => {
                    ...
                    console.log('Data Surat Ghoib:', {
                        ...
                        status_asli: d.status_perkawinan ?? d.status,
                        ...
                        pekerjaan_hasil: normalisasiPekerjaan(d.pekerjaan)
                    });
                })
                .catch(error => {
                    console.error(
