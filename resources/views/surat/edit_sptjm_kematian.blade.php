        ...
        <div class="col-lg-12 mx-auto">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('surat.sptjm.update', $surat->_id ?? $surat->id) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="ttl_tempat" class="form-control @error('ttl_tempat') is-invalid @enderror"
                                       value="{{ old('ttl_tempat', $surat->ttl_tempat) }}" required>
                                @error('ttl_tempat') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tanggal Lahir</label>
                                <input type="date" name="ttl_tanggal" class="form-control @error('ttl_tanggal') is-invalid @enderror"
                                       value="{{ old('ttl_tanggal', optional($surat->ttl_tanggal)->format('Y-m-d')) }}" required>
                                @error('ttl_tanggal') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Pekerjaan <span class="text-danger">*</span></label>
                            <select name="pekerjaan" class="form-control @error('pekerjaan') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_jenazah" class="form-control @error('nama_jenazah') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nik_jenazah" class="form-control @error('nik_jenazah') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="ttl_tempat_jenazah" class="form-control @error('ttl_tempat_jenazah') is-invalid @enderror"
                                       value="{{ old('ttl_tempat_jenazah', $surat->ttl_tempat_jenazah) }}" required>
                                @error('ttl_tempat_jenazah') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tanggal Lahir Jenazah</label>
                                <input type="date" name="ttl_tanggal_jenazah" class="form-control @error('ttl_tanggal_jenazah') is-invalid @enderror"
                                       value="{{ old('ttl_tanggal_jenazah', optional($surat->ttl_tanggal_jenazah)->format('Y-m-d')) }}" required>
                                @error('ttl_tanggal_jenazah') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_ayah_kandung" class="form-control @error('nama_ayah_kandung') is-invalid @enderror"
                                   value="{{ old('nama_ayah_kandung', $surat->nama_ayah_kandung) }}" required>
                            @error('nama_ayah_kandung') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
