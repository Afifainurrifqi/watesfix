                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body bg-success text-center bg-img" style="background-image: url('assets4/dist/img/core-img/2.png')">
                            ...
                            <p class="mb-0 fz-12 text-white">Jumlah Lahan</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body bg-danger text-center bg-img" style="background-image: url('assets4/dist/img/core-img/1.png')">
                            ...
                            <p class="mb-0 fz-12 text-white">Luas Lahan</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body bg-primary text-center bg-img" style="background-image: url('assets4/dist/img/core-img/2.png')">
                            ...
                            <p class="mb-0 fz-12 text-white">Jenis Tanaman</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <h4 class="mb-1 text-info">
                                        <span class="counter text-white">250</span><span class="text-white">k</span>
                                    </h4>
                                    <p class="mb-0 fz-12 text-white">Pupuk Subsidi</p>
                                </div>
                                <div class="col-6">
                                    <i class="bi bi-eject-fill mb-2 text-white"></i>
                                    <h4 class="mb-1 text-warning">
                                        <span class="counter text-white">150</span><span class="text-white">k</span>
                                    </h4>
                                    <p class="mb-0 fz-12 text-white">Pupuk Non-Subsidi</p>
                                </div>
                            </div>
                        </div>
                    </div>
