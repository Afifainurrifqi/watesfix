...
@section('content')
    <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-header">
                            ...
                            @endif
                            <h2 class="card-title">LOKASI, PEMUKIMAN, DAN AKSES FASILITAS</h2>
                        </div>
                            ...
                            <table class="table table-striped table-bordered" id="tabledatalokasidanpemukiman"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">PAUD</th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">TK/RA</th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">SD/MI
                                            SEDERAJAT</th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">SMP/MTs
                                            SEDERAJAT</th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">SMA/MA
                                            SEDERAJAT</th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">PERGURUAN
                                            TINGGI</th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">PESANTREN
                                        </th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">SEMINARI
                                        </th>
                                        <th colspan="3" style="background-color: #e3f2fd; text-align: center;">PENDIDIKAN
                                            KEAGAMAAN LAIN</th>

                                        <th colspan="3" style="background-color: #e8f5e9; text-align: center;">RUMAH
                                            SAKIT</th>
                                        <th colspan="3" style="background-color: #e8f5e9; text-align: center;">RUMAH
                                            SAKIT BERSALIN</th>
                                        <th colspan="3" style="background-color: #e8f5e9; text-align: center;">POLIKLINIK
                                        </th>
                                        <th colspan="3" style="background-color: #e8f5e9; text-align: center;">PUSKESMAS
                                        </th>
                                        <th colspan="3" style="background-color: #e8f5e9; text-align: center;">POSKESDES
                                        </th>
                                        <th colspan="3" style="background-color: #e8f5e9; text-align: center;">POSYANDU
                                        </th>
                                        ...
                                        <th colspan="3" style="background-color: #fff3e0; text-align: center;">DOKTER
                                            UMUM</th>
                                        <th colspan="3" style="background-color: #fff3e0; text-align: center;">BIDAN
                                        </th>
                                        <th colspan="3" style="background-color: #fff3e0; text-align: center;">TENAGA
                                            KESEHATAN / PERAWAT</th>
                                        <th colspan="3" style="background-color: #fff3e0; text-align: center;">DUKUN
                                        </th>

                                        <th colspan="5" style="background-color: #f3e5f5; text-align: center;">LOKASI
                                            PEKERJAAN UTAMA</th>
                                        <th colspan="5" style="background-color: #f3e5f5; text-align: center;">LAHAN
                                            PERTANIAN YANG DIUSAHAKAN</th>
                                        <th colspan="5" style="background-color: #f3e5f5; text-align: center;">SEKOLAH
                                        </th>
                                        <th colspan="5" style="background-color: #f3e5f5; text-align: center;">BEROBAT
                                        </th>
                                        <th colspan="5" style="background-color: #f3e5f5; text-align: center;">
                                            BERIBADAH MINGGUAN/BULANAN/TAHUNAN</th>
                                        <th colspan="5" style="background-color: #f3e5f5; text-align: center;">REKREASI
                                            TERDEKAT</th>

                                        <th colspan="2" style="background-color: #fff3e0; text-align: center;">
                                            TRANSPORTASI UMUM</th>
                                        <th colspan="8" style="background-color: #e8f5e9; text-align: center;">
                                            PEMANFAAT PROGRAM PEMERINTAH</th>
                                        <th rowspan="2">RATA-RATA PENGELUARAN / BULAN (Rp)</th>
                                    </tr>
                                    <tr>
                                        @for ($i = 0; $i < 9; $i++)
                                            <th>JARAK (KM)</th>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <h4 class="card-title">Persentase Penyelesaian Data</h4>
                <div class="progress">
        ...
        $(function() {
            $('#tabledatalokasidanpemukiman').DataTable({
                ...
                columns: [
                    ...
                    // 21-30 Sanitasi & Kerawanan Geografis
                    {
                        data: 'tempat_sampah',
                        name: 'tempat_sampah'
                    },
                    ...
                    // AKSES PENDIDIKAN (PAUD, TK, SD, SMP, SMA, PT, Pesantren, Seminari, Keagamaan Lain)
                    {
                    ...
                    // AKSES KESHATAN (RS, RS Bersalin, Poliklinik, Puskesmas, Poskesdes, Posyandu, Apotik, Toko Obat)
                    {
                    ...
                    // AKSES TENAGA KESEHATAN (Dr Spesialis, Dr Umum, Bidan, Perawat, Dukun)
                    {
                    ...
                    // AKSES SARPRAS (Pekerjaan, Tani, Sekolah, Berobat, Ibadah, Rekreasi)
                    {
