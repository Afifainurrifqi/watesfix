        ...
        <div class="container">
            <div
                ...
                <div class="page-heading">
                    <h6 class="mb-0">Pernyataan Belum Mengurus Akta</h6>
                </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('surat.userbelumakta.store') }}" method="POST">
                        ...
                        <div class="element-heading mb-2">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="subjek_tempat_lahir" name="subjek_tempat_lahir" type="text"
                                class="form-control" required value="{{ old('subjek_tempat_lahir') }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="subjek_tanggal_lahir">Tanggal Lahir</label>
                            <input id="subjek_tanggal_lahir" name="subjek_tanggal_lahir" type="date"
                                class="form-control" required value="{{ old('subjek_tanggal_lahir') }}">
                        </div>
