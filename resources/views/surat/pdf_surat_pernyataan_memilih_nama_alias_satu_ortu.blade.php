...
<body>
    ...
    <div class="nomor-surat">
        Nomor: {{ app(\App\Services\NomorSuratService::class)->display($data, 'nama_alias_ortu') }}
    </div>
    ...
    <table class="data">
        <tr>
            <td>Nama</td>
            <td>: {{ $data->nama_menyatakan ?? $data->nama ?? '...........................................' }}</td>
        </tr>
        <tr>
            <td>NIK</td>
            <td>: {{ $data->nik ?? '...........................................' }}</td>
    ...
    <p class="tulisan" style="margin-left: 15px;">
        ...
        alias
        {{ $data->nama_alias_ayah ?? $data->nama_alias_ibu ?? '...........................................' }}
    </p>
    ...
    <p class="tulisan" style="margin-left: 15px;">
        ...
        @if(!empty($data->nama_alias_dihapus_2))
            dan {{ $data->nama_alias_dihapus_2 }}
        @endif
    </p>
...
<br><br><br><br>
            ...
            <p>
                <strong>
                    ( {{ $data->nama_menyatakan ?? $data->nama ?? '...........................................' }} )
                </strong>
            </p>
        </div>
    </div>
