                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="ttl_tempat" name="ttl_tempat" class="form-control"
                                            required value="{{ old('ttl_tempat') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Lahir</label>
                                        <input type="date" id="ttl_tanggal" name="ttl_tanggal" class="form-control"
                                            required value="{{ old('ttl_tanggal') }}">
                                    </div>
                                </div>
                            </div>
