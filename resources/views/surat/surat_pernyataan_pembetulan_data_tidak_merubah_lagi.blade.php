                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('surat.pembetulandata.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Contoh: Perubahan nama dari "Ahmad" menjadi "Ahmad
                                    Santoso"</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="data_pendukung_1" class="form-control"
                                    value="{{ old('data_pendukung_1') }}">
                            </div>
                            <div class="mb-3">
                                <label>Data Pendukung 2</label>
                                <input type="text" name="data_pendukung_2" class="form-control"
                                    value="{{ old('data_pendukung_2') }}">
                            </div>
                            <div class="mb-3">
                                <label>Data Pendukung 3</label>
                                <input type="text" name="data_pendukung_3" class="form-control"
                                    value="{{ old('data_pendukung_3') }}">
                            </div>
                            <div class="mb-3">
                                <label>Data Pendukung 4</label>
                                <input type="text" name="data_pendukung_4" class="form-control"
                                    value="{{ old('data_pendukung_4') }}">
                            </div>
                            <div class="mb-3">
                                <label>Data Pendukung 5</label>
                                <input type="text" name="data_pendukung_5" class="form-control"
                                    value="{{ old('data_pendukung_5') }}">
                            </div>
