...
<head>
    ...
    <title>Form Surat Keterangan Desa Miskin</title>
    ...
    <div class="container">
        <div class="header-content position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="page-heading">
                <h6 class="mb-0">Form Surat Keterangan Desa Miskin</h6>
            </div>
...
<div class="page-content-wrapper py-3">
    <div class="container">
        <div class="element-heading">
            <h6>Buat Pengajuan Surat Keterangan Desa Miskin</h6>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="{{ route('surat.usermiskindesa.store') }}" method="POST">
                    @csrf
