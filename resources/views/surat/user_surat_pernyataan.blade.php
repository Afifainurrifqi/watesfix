    ...
    <div class="container">
      ...
      <div class="card service-card bg-info bg-gradient mb-3">
        <div class="card-body">
          <div class="d-flex align-items-center">
            <div class="service-text">
              <h5>Permohonan</h5>
              <p class="mb-0">Pembukaan Rekening Tabungan</p>
            </div>
            <div class="service-img">
              <a class="btn m-1 btn-creative btn-light" href="#">Buat Surat</a>
            </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            <div class="service-text">
              ...
              <p class="mb-0 text-dark">Kepemilikan Dokumen Asli</p>
            </div>
            <div class="service-img">
               <a class="btn m-1 btn-creative btn-light" href="#">Buat Surat</a>
            </div>
      ...
      <div class="card service-card bg-warning bg-gradient mb-3">
        <div class="card-body">
          <div class="d-flex align-items-center">
            <div class="service-text">
              <h5 class="text-dark">Surat Pernyataan</h5>
              <p class="mb-0 text-dark">Kesanggupan</p>
            </div>
            <div class="service-img">
              <a class="btn m-1 btn-creative btn-light" href="#">Buat Surat</a>
            </div>
      ...
      <div class="card service-card bg-warning bg-gradient">
        <div class="card-body">
          <div class="d-flex align-items-center">
            <div class="service-text">
              <h5 class="text-dark">Surat Perintah</h5>
              <p class="mb-0 text-dark">Perjalanan Dinas</p>
            </div>
            <div class="service-img">
             <a class="btn m-1 btn-creative btn-light" href="#">Buat Surat</a>
            </div>
