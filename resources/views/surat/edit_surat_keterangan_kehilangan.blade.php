                ...
                <form action="{{ route('suratkehilangan.update', $surat_keterangan_kehilangan->_id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_lahir_pelapor" id="tanggal_lahir_pelapor" class="form-control"
                            required
                            value="{{ old('tanggal_lahir_pelapor', $formatTanggalInput($surat_keterangan_kehilangan->tanggal_lahir_pelapor ?? '')) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <select name="jenis_kelamin_pelapor" id="jenis_kelamin_pelapor" class="form-control" required>
                            ...
                            <option value="Laki-laki"
                                {{ old('jenis_kelamin_pelapor', $surat_keterangan_kehilangan->jenis_kelamin_pelapor) == 'Laki-laki' ? 'selected' : '' }}>
                                Laki-laki</option>
                            <option value="Perempuan"
                                {{ old('jenis_kelamin_pelapor', $surat_keterangan_kehilangan->jenis_kelamin_pelapor) == 'Perempuan' ? 'selected' : '' }}>
                                Perempuan</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="agama_pelapor" id="agama_pelapor" class="form-control" required>
                            ...
                            @foreach (['Islam', 'Kristen', 'Katolik', 'Hindu', 'Buddha', 'Khonghucu'] as $agama)
                                <option value="{{ $agama }}"
                                    {{ old('agama_pelapor', $surat_keterangan_kehilangan->agama_pelapor) == $agama ? 'selected' : '' }}>
                                    {{ $agama }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select name="status_pelapor" id="status_pelapor" class="form-control" required>
                            ...
                            @foreach (['Kawin', 'Belum Kawin', 'Cerai Hidup', 'Cerai'] as $status)
                                <option value="{{ $status }}"
                                    {{ old('status_pelapor', $surat_keterangan_kehilangan->status_pelapor) == $status ? 'selected' : '' }}>
                                    {{ $status }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select name="pekerjaan_pelapor" id="pekerjaan_pelapor" class="form-control" required>
                            ...
                            @foreach ($jobs as $job)
                                <option value="{{ $job }}"
                                    {{ old('pekerjaan_pelapor', $surat_keterangan_kehilangan->pekerjaan_pelapor) == $job ? 'selected' : '' }}>
                                    {{ $job }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_kehilangan" id="tanggal_kehilangan" class="form-control"
                            required
                            value="{{ old('tanggal_kehilangan', $formatTanggalInput($surat_keterangan_kehilangan->tanggal_kehilangan ?? '')) }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_surat" id="status_surat" class="form-control" required>
                            ...
                            @foreach (['Pending', 'Di cek', 'Di terima', 'Ditolak'] as $status)
                                <option value="{{ $status }}"
                                    {{ old('status_surat', $surat_keterangan_kehilangan->status_surat) == $status ? 'selected' : '' }}>
                                    {{ $status }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_verif" id="status_verif" class="form-control" required>
                            ...
                            @foreach (['Belum Verifikasi', 'Terverifikasi'] as $verif)
                                <option value="{{ $verif }}"
                                    {{ old('status_verif', $surat_keterangan_kehilangan->status_verif) == $verif ? 'selected' : '' }}>
                                    {{ $verif }}</option>
                            @endforeach
                        </select>
                    </div>
