            ...
            <div class="col-lg-12 mx-auto">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="mb-0">Form SPTJM Kematian</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('surat.sptjm.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3"><label>Nama Ayah Kandung</label><input type="text"
                                    ...
                                    required></div>
                            <div class="mb-3"><label>Nama Ibu Kandung</label><input type="text" name="nama_ibu_kandung"
                                    class="form-control" value="{{ old('nama_ibu_kandung') }}" required></div>
