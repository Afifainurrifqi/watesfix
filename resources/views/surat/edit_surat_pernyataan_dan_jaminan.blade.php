            ...
            <div class="card-body">
                    ...
                    $formatTanggalInput = function ($value) {
                        ...
                        try {
                            if ($value instanceof \MongoDB\BSON\UTCDateTime) {
                                return \Carbon\Carbon::instance($value->toDateTime())->format('Y-m-d');
                            }
                ...
                <form action="{{ route('surat.pernyataandanjaminan.update', $surat->_id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nama_pembuat') is-invalid @enderror" name="nama_pembuat"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nik_pembuat') is-invalid @enderror" name="nik_pembuat"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat_pembuat') is-invalid @enderror" name="alamat_pembuat" rows="2"
                            required>{{ old('alamat_pembuat', $surat->alamat_pembuat) }}</textarea>
                        @error('alamat_pembuat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('hubungan_dengan_terjamin') is-invalid @enderror"
                            name="hubungan_dengan_terjamin" placeholder="Orang Tua/Wali/Saudara/Atasan"
                            value="{{ old('hubungan_dengan_terjamin', $surat->hubungan_dengan_terjamin) }}" required>
                        @error('hubungan_dengan_terjamin')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nama_terjamin') is-invalid @enderror" name="nama_terjamin"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nik_terjamin') is-invalid @enderror" name="nik_terjamin"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat_terjamin') is-invalid @enderror" name="alamat_terjamin" rows="2"
                            required>{{ old('alamat_terjamin', $surat->alamat_terjamin) }}</textarea>
                        @error('alamat_terjamin')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('uraian_pernyataan') is-invalid @enderror" name="uraian_pernyataan" rows="3"
                            required>{{ old('uraian_pernyataan', $surat->uraian_pernyataan) }}</textarea>
                        @error('uraian_pernyataan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('berlaku_mulai') is-invalid @enderror"
                            name="berlaku_mulai"
                            value="{{ old('berlaku_mulai', $formatTanggalInput($surat->berlaku_mulai ?? '')) }}" required>
                        @error('berlaku_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('berlaku_sampai') is-invalid @enderror"
                            name="berlaku_sampai"
                            value="{{ old('berlaku_sampai', $formatTanggalInput($surat->berlaku_sampai ?? '')) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('berdasarkan') is-invalid @enderror" name="berdasarkan" rows="2">{{ old('berdasarkan', $surat->berdasarkan) }}</textarea>
                        @error('berdasarkan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('status_surat') is-invalid @enderror" id="status_surat"
                            name="status_surat" required>
                            @php $statusNow = old('status_surat', $surat->status_surat); @endphp
                            @foreach (['Pending', 'Di cek', 'Di terima', 'Ditolak'] as $st)
                                <option value="{{ $st }}" {{ $statusNow === $st ? 'selected' : '' }}>
                                    {{ $st }}</option>
                            @endforeach
                        </select>
                        @error('status_surat')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('status_verif') is-invalid @enderror" id="status_verif"
                            name="status_verif" required>
                            @php $verifNow = old('status_verif', $surat->status_verif); @endphp
                            @foreach (['Belum Verifikasi', 'Terverifikasi'] as $vf)
                                <option value="{{ $vf }}" {{ $verifNow === $vf ? 'selected' : '' }}>
                                    {{ $vf }}</option>
                            @endforeach
                        </select>
                        @error('status_verif')
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nowa') is-invalid @enderror" name="nowa"
