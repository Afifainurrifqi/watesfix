...
<body>
                    ...
                    <form action="{{ route('surat.usertidakmampu.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kewarganegaraan" id="kewarganegaraan" class="form-control" required>
                                ...
                                <option value="Warga Negara Indonesia (WNI)" {{ old('kewarganegaraan') == 'Warga Negara Indonesia (WNI)' ? 'selected' : '' }}>
                                    Warga Negara Indonesia (WNI)
                                </option>
                                <option value="Warga Negara Asing (WNA)" {{ old('kewarganegaraan') == 'Warga Negara Asing (WNA)' ? 'selected' : '' }}>
                            ...
                            <select name="pekerjaan" id="pekerjaan" class="form-control" required>
                                ...
                                @php
                                    $jobs = [
                                        ...
                                        "IBU RUMAH TANGGA", "WIRASWASTA", "PETANI/PEKEBUN", "BURUH TANI",
                                        "PEDAGANG", "PEGAWAI NEGERI SIPIL (PNS)", "KARYAWAN HONORER",
                                        "BURUH HARIAN LEPAS", "SOPIR", "KARYAWAN BUMN", "PENSIUNAN", "Lainnya"
                                    ];
                                @endphp
                                @foreach($jobs as $job)
    ...
    <script>
            ...
            fetch(`/datapenduduk/lookup/${nik}`)
                ...
                .then(result => {
                    if (result.success && result.data) {
                        ...
                        // Autofill Kewarganegaraan (jika ada di data penduduk)
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (nikInput) nikInput.addEventListener('blur', autofillTidakMampu);
        });
    </script>
</body>
</html>
