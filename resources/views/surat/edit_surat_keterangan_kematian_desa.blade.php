                ...
                <form action="{{ route('surat.kematian.update', $surat->_id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nik" id="nik" class="form-control"
                            value="{{ old('nik', $surat->nik ?? ($surat->nik_almarhum ?? ($surat->nik_pelapor ?? ''))) }}">
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="tanggal" class="form-label">Tanggal Meninggal <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="penyebab" class="form-label">Disebabkan Karena <span
                                class="text-danger">*</span></label>
