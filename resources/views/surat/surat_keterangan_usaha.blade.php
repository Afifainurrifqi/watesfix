...
<div class="container">
    <div class="card shadow-sm">
        <div class="card-body">
            <h4 class="mb-4">Form Surat Keterangan Usaha</h4>
            ...
            <form action="{{ route('surat.usaha.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="status_surat" id="status_surat" class="form-control" required>
                        ...
                        @foreach (['Pending', 'Di cek', 'Di terima', 'Ditolak'] as $status)
                            <option value="{{ $status }}" {{ old('status_surat', 'Pending') == $status ? 'selected' : '' }}>{{ $status }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="status_verif" id="status_verif" class="form-control" required>
                        ...
                        @foreach (['Belum Verifikasi', 'Terverifikasi'] as $verif)
                            <option value="{{ $verif }}" {{ old('status_verif', 'Belum Verifikasi') == $verif ? 'selected' : '' }}>{{ $verif }}</option>
                        @endforeach
                    </select>
                </div>
