                        ...
                        <form action="{{ route('surat.izinkk.update', $surat->_id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_izin" class="form-control"
                                    value="{{ old('nama_izin', $surat->nama_izin) }}" required>
                            </div>

                            <div class="mb-3">
                                <label>NIK <span class="text-danger">*</span></label>
                                <input type="text" name="nik_izin" class="form-control"
                                    value="{{ old('nik_izin', $surat->nik_izin) }}" required>
                            </div>

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label>Tempat Lahir</label>
                                    <input type="text" name="ttl_tempat_izin" class="form-control"
                                        value="{{ old('ttl_tempat_izin', $surat->ttl_tempat_izin) }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Tanggal Lahir</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tujuan_pindah" class="form-control"
                                    value="{{ old('tujuan_pindah', $surat->tujuan_pindah) }}" required>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="status_surat" class="form-control" required>
                                        @foreach (['Pending', 'Di cek', 'Di terima', 'Ditolak'] as $st)
                                            <option value="{{ $st }}"
                                                {{ old('status_surat', $surat->status_surat) == $st ? 'selected' : '' }}>
                                                {{ $st }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="status_verif" class="form-control" required>
                                        @foreach (['Belum Verifikasi', 'Terverifikasi'] as $sv)
                                            <option value="{{ $sv }}"
                                                {{ old('status_verif', $surat->status_verif) == $sv ? 'selected' : '' }}>
                                                {{ $sv }}</option>
                                        @endforeach
                                    </select>
                                </div>
