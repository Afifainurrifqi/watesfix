            ...
            <div class="card-body">
                ...
                <form action="{{ route('surat.pernyataandanjaminan.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="nama_terjamin" required value="{{ old('nama_terjamin') }}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">NIK Terjamin</label>
                        <input class="form-control" name="nik_terjamin" required value="{{ old('nik_terjamin') }}">
                    </div>
                    <div class="mb-3">
