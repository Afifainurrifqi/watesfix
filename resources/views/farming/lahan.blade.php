    ...
    <div class="page-content-wrapper">
        ...
        <div class="container direction-rtl">
            <div class="row g-1">
                <div class="col-4">
                    <div class="card mb-3">
                        <div class="card-body text-center">
                            <a href="{{ route('farm.tambahlahan') }}" class="block">
                                <div class="card mx-auto bg-gray d-flex justify-content-center align-items-center">
                                    <img src="assets4/dist/img/demo-img/add-button.png" alt="Tambah Lahan"
                                        class="img-fluid" style="max-width: 50px; height: auto;"">
                                </div>
                                <p class="mt-2 mb-0">Tambah Lahan</p>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="card mb-3">
                        <div class="card-body text-center">
                            <a href="{{ route('farm.updatelahan') }}" class="block">
                                <div class="card mx-auto bg-gray d-flex justify-content-center align-items-center">
                                    <img src="assets4/dist/img/demo-img/update.png" alt="Update Lahan"
                                        class="img-fluid" style="max-width: 50px; height: auto;"">
                                </div>
                                <p class="mt-2 mb-0">Update Lahan</p>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="card mb-3">
                        <div class="card-body text-center">
                            <a href="{{ route('farm.semualahan') }}" class="block">
                                <div class="card mx-auto bg-gray d-flex justify-content-center align-items-center">
                                    <img src="assets4/dist/img/demo-img/field.png" alt="Informasi semua lahan"
                                        class="img-fluid" style="max-width: 50px; height: auto;"">
                                </div>
                                <p class="mt-2 mb-0">Cek Lahanmu</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <table class="w-100" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Jl. Ahmad Yani No. 12</td>
                                <td>2,8 hektar</td>
                                <td>Karet</td>
                            </tr>
                            <tr>
                                <td>Jl. Gajah Mada No. 30</td>
                                <td>1 hektar</td>
                                <td>Kelapa</td>
                            </tr>
                            <tr>
                                <td>Jl. Sisingamangaraja No. 5</td>
                                <td>2,5 hektar</td>
                                <td>Kakao</td>
                            </tr>
                            <tr>
                                <td>Jl. Cendrawasih No. 7</td>
                                <td>1,2 hektar</td>
                                <td>Singkong</td>
                            </tr>
                            <tr>
                                <td>Jl. Rajawali No. 18</td>
                                <td>4 hektar</td>
                                <td>Karet</td>
                            </tr>
                            <tr>
                                <td>Jl. Kenari No. 22</td>
                                <td>1,8 hektar</td>
                                <td>Teh</td>
                            </tr>
                            <tr>
                                <td>Jl. Melati No. 14</td>
                                <td>3,2 hektar</td>
                                <td>Kelapa Sawit</td>
                            </tr>
                        </tbody>
      ...
      <div class="card bg-primary mb-3 bg-img" style="background-image: url('img/core-img/1.png')">
        <div class="card-body direction-rtl p-4">
          ...
          <a class="btn btn-primary" href="pages.html">All Pages <i class="bi bi-arrow-right"></i></a>
        </div>
      </div>
    </div> --}}
