            ...
            <div class="card-body">
                ...
                <form action="{{ route('surat.skm.update', $surat->_id ?? $surat->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        @php
                            $pekerjaanNow = old('pekerjaan', $surat->pekerjaan ?? '');
                            ...
                            // Kalau pekerjaan lama tidak ada di daftar,
                            // tetap tampilkan di paling atas agar tidak kosong saat edit.
                    ...
                    <div class="text-end">
                        ...
                        <a href="{{ route('surat.skm.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
